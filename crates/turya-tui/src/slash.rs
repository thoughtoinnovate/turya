...
mod tests {
    ...
    fn filter_prefix_first_then_alpha() {
        ...
        assert_eq!(
            all,
            vec![
                "auth", "clear", "compact", "context", "efforts", "help", "models", "queue",
                "sessions", "settings", "steps", "thinking"
            ]
        );
    ...
    fn completer_matches_token_only() {
        ...
        assert_eq!(c.matches("/", &reg).len(), 12);
    }
